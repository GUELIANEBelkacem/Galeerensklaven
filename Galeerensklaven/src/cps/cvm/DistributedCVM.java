...
public class DistributedCVM extends AbstractDistributedCVM{
	...
	public void instantiateAndPublish() throws Exception {
		...
		if(AbstractCVM.getThisJVMURI().equals(rot1)){ 
			...
			AbstractComponent.createComponent(RoutingNode.class.getCanonicalName(), new Object[] {1,new Position(5, 5)});

		}
		else {if(AbstractCVM.getThisJVMURI().equals(rot2)){
			
			AbstractComponent.createComponent(RoutingNode.class.getCanonicalName(), new Object[] {2,new Position(6, 5)});
		} 
		else {if(AbstractCVM.getThisJVMURI().equals(ter)){
			
			AbstractComponent.createComponent(TerminalNode.class.getCanonicalName(), new Object[] {1,new Position(4, 5)});
		} 
		else {if(AbstractCVM.getThisJVMURI().equals(cla)){
			AbstractComponent.createComponent(ClassicalNode.class.getCanonicalName(), new Object[] {1,new Position(10, 10)});

		} 
		else {if(AbstractCVM.getThisJVMURI().equals(acc)){
			
			AbstractComponent.createComponent(AccessPoint.class.getCanonicalName(), new Object[] {1,new Position(7, 5)});
