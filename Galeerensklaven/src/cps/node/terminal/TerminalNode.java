...
@RequiredInterfaces(required = {TerminalInondationRequiredCI.class, TerminalRegRequiredCI.class})
...
public class TerminalNode extends AbstractComponent {
	...
	public final String COMM_URI = "comm-uri-" + i;
	...
	/*public TerminalNode(String reflectionInboundPortURI, int nbThreads, int nbSchedulableThreads) {
	...
	public synchronized void execute() throws Exception{
		super.execute();
		voisins = this.trop.register(address, COMM_URI, initialPosition, initialRange);
