...
public class RegistrationOutboundPort extends AbstractInboundPort implements RegistrationCI {
	...
	public Set<ConnectionInfo> registerTerminalNode(NodeAddressI address, String commIpUri, PositionI initialPosition,
		...
		return this.getOwner().handleRequest(
				t -> ((TerminalNode) t).registerTerminal(address, commIpUri, initialPosition, initialRange));
	}
